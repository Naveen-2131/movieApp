import backup from "../assets/images.png"
  ...
  return (
    <div className="col">
      <div className="card shadow-sm" title={title}>
        ...
        <h5 className="card-title text-info text-overflow-1">{title}</h5>
       <p className="card-text text-overflow-2">{overview}</p>
       <div className="d-flex justify-content-between align-items-center">
        <Link to={`/movie/${id}`} className="btn btn-sm btn-outline-info strectched-link">Read More</Link>
      <small>
